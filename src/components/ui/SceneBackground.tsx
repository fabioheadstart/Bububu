...
// ── Caminhão de areia do pai do Miguel ────────────────────────────────────────
function TinyTruck() {
  const [visible, setVisible] = useState(false)
  useEffect(() => {
    let t: ReturnType<typeof setTimeout>
    ...
    <>
      ...
      <div style={{
        ...
        <svg width="150" height="54" viewBox="0 0 150 54">
          {/* Cab — frente à esquerda, indo direita→esquerda */}
          <rect x="0"  y="18" width="46" height="24" rx="3" fill="white" opacity="0.92" />
          <rect x="10" y="8"  width="34" height="18" rx="5" fill="white" />
          <rect x="13" y="11" width="24" height="11" rx="2" fill="rgba(150,210,255,0.55)" />
          <ellipse cx="4"  cy="34" rx="3.5" ry="3" fill="#fde68a" opacity="0.9" />
          <ellipse cx="4"  cy="34" rx="6"   ry="5" fill="rgba(253,230,138,0.15)" />
          {/* Carroceria */}
          <rect x="46" y="14" width="100" height="24" rx="2" fill="white" opacity="0.85" />
          <rect x="46" y="10" width="100" height="6"  rx="1" fill="rgba(220,220,220,0.85)" />
          {/* Areia */}
          <ellipse cx="96" cy="14" rx="44" ry="9" fill="rgba(210,180,100,0.50)" />
          {/* Rodas */}
          <circle cx="20"  cy="47" r="8" fill="#2a2a3a" /><circle cx="20"  cy="47" r="3.5" fill="#555" />
          <circle cx="58"  cy="47" r="8" fill="#2a2a3a" /><circle cx="58"  cy="47" r="3.5" fill="#555" />
          <circle cx="100" cy="47" r="8" fill="#2a2a3a" /><circle cx="100" cy="47" r="3.5" fill="#555" />
          <circle cx="126" cy="47" r="7" fill="#2a2a3a" /><circle cx="126" cy="47" r="3"   fill="#555" />
        </svg>
      </div>
    </>
  )
    ...
    <>
      ...
      <div style={{
        ...
        <svg width="120" height="46" viewBox="0 0 120 46">
          {/* Corpo */}
          <rect x="5"  y="22" width="112" height="18" rx="5" fill="white" opacity="0.92" />
          {/* Teto */}
          <rect x="22" y="9"  width="68"  height="18" rx="9" fill="white" />
          {/* Janelas */}
          <rect x="26" y="12" width="26" height="12" rx="3" fill="rgba(150,210,255,0.55)" />
          <rect x="58" y="12" width="26" height="12" rx="3" fill="rgba(150,210,255,0.55)" />
          {/* Farol (direita = frente, indo esq→dir) */}
          <ellipse cx="116" cy="30" rx="4" ry="3" fill="#fde68a" opacity="0.9" />
          <ellipse cx="116" cy="30" rx="7" ry="5" fill="rgba(253,230,138,0.12)" />
          {/* Lanterna traseira */}
          <ellipse cx="6" cy="30" rx="3" ry="2.5" fill="rgba(255,80,80,0.55)" />
          {/* Rodas */}
          <circle cx="30" cy="40" r="8" fill="#2a2a3a" /><circle cx="30" cy="40" r="3.5" fill="#555" />
          <circle cx="90" cy="40" r="8" fill="#2a2a3a" /><circle cx="90" cy="40" r="3.5" fill="#555" />
        </svg>
      </div>
    </>
  )
...
/** Estrada com veículos — renderizada separadamente no FeedScreen dentro da zona de cena */
export function VehicleRoad() {
  return (
    <div style={{
      position: 'absolute',
      bottom: '4%',
...
export function SceneBackground({ isKids = false, worldId = 1 }: { isKids?: boolean; worldId?: KidsWorldId }) {
  ...
  return isKids ? renderKidsWorld() : <ProBackground />
}
